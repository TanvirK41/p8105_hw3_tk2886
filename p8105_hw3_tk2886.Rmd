...
new_accel_df %>%
  ...
  theme(legend.position = "right")
```
**Analysis of Graph 1:** One trend that is indicated from the graph is that the activity count is higher later on night on Thursday, Friday, Saturday. Earlier in the week like Sunday and Monday, the activity count is higher in the late morning hours to afternoon (12pm) hour. 
