...
instacart_df %>%
  ...
  knitr::kable()
```
After analyzing the dataset, there are **134 aisles**. The top five aisles with the most items ordered from are **fresh vegetables**, **fresh fruits**, **packaged vegetables fruits**, **yogurt**, and **packaged cheese**. 
...
After analyzing this spaghetti plot, it is shown that the average data_avalue of the places within the states varies from 2002 to 2010. 
