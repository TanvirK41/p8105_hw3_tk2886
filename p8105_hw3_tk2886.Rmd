...
This plot shows the number of items ordered in each Aisle from the Aisles that have more than 10,000 items ordered.The plot is arranged in a fashion that shows the aisles with the most items ordered and then subsequently shows the aisles with the least items ordered. The top five aisles from the aisles with more than 10,000 items are Fresh Vegetables, Fresh Fruits, Packaged vegetable fruits, yogurts, and packaged cheese. 
