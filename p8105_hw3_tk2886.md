...
a fashion that shows the aisles with the most items ordered and then
subsequently shows the aisles with the least items ordered. The top five
aisles from the aisles with more than 10,000 items are Fresh Vegetables,
Fresh Fruits, Packaged vegetable fruits, yogurts, and packaged cheese.
...
within the states varies from 2002 to 2010. The data values varies from
2002 to 2010 for the states.
...
**Analysis of Graph 1:** One trend that is indicated from the graph is
that the activity count is higher later on night on Thursday, Friday,
Saturday. Earlier in the week like Sunday and Monday, the activity count
is higher in the late morning hours to afternoon (12pm) hour.
