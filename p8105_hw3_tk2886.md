...
Based on the online information, Instacart is an online grocery service
that allows people to shop online from local stores. In New York City,
some of the partner stores include Whole Foods, Fairway, and The Food
Emporium. “The Instacart Online Grocery Shopping Dataset 2017” is an
anonymized dataset with over 3 million online grocery orders from more
than 200,000 Instacart users. We will be using this dataset to analyze
specific things and outputting the results in a table or visual plots.
...
This plot shows the number of items ordered in each Aisle with Aisles
that have more than 10,000 products ordered. The top five aisles with
more than 10000 items ordered that have most items ordered are Fresh
Vegetables, Fresh Fruits, Packaged vegetable fruits, yogurts, and
packaged cheese.
