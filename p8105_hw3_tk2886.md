...
After analyzing the dataset, there are **134** aisles.  
The top aisle in the dataset is **fresh vegetables**. The top five
aisles with the most items ordered from are **fresh vegetables, fresh
fruits, packaged vegetables fruits, yogurt, packaged cheese**.
...
After analyzing this spaghetti plot, it is shown that the average
data\_avalue of the places within the states varies from 2002 to 2010.
