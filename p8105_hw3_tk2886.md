...
The spaghetti plot is showing the BRFSS data value of the places within
the states from 2002 to 2010. The data values vary for the states from
2002 to 2010. It is hard to state if there’s a trend happening for each
specific state or across each state since the data values vary the we
progress from 2002 to 2010. However, we may state that the average data
value for some states starts high and then it decreases.
